...
class ComposerAutoloaderInit6ed8268eba1dc7db9a078901b8d1e56d
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit6ed8268eba1dc7db9a078901b8d1e56d::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire6ed8268eba1dc7db9a078901b8d1e56d($fileIdentifier, $file);
        }
...
function composerRequire6ed8268eba1dc7db9a078901b8d1e56d($fileIdentifier, $file)
{
