				  ...
				  "data": function(data){
                	...
                	columns: [	
                        ...
                        {"data": "valid_bayar",
                            render: function (data, type, row) {
                                if (data === "") {
                                    return '<i class="text-warning">Belum Valid</i>';
                                }
                                if (data == 2) {
                        ...
                        {"data": "ujian",
                            render: function (data, type, row) {
                                if (data == 1) {
                                    return '<i class="text-info">Terdaftar</i>';
                                }
                                
                                return '<i class="text-danger">Tidak Terdaftar</i>';
                             }
                        },
                         {"data": "umumkan",
                            render: function (data, type, row) {
                                if (data == 1) {
                                    return '<i class="text-info">Sudah</i>';
                                }
