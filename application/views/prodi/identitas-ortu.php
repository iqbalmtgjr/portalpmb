                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group date" id="tanggallahir" data-target-input="nearest">
                            <input type="text" name="tglay" class="form-control datetimepicker-input" data-target="#tanggallahir" value="<?php if(!empty($ortu->	tgl_lahir_ayah)) { echo $ortu->	tgl_lahir_ayah; } else {echo set_value('tglay'); }?>" placeholder="Tanggal Lahir">
                  ...
                  <!-- form start -->
                    ...
                    <div class="col-sm-6">
                        <div class="input-group date" id="tanggallahir1" data-target-input="nearest">
                            <input type="text" name="tgl_ib" class="form-control datetimepicker-input" data-target="#tanggallahir1" value="<?php if(!empty($ortu->tgl_lahir_ibu)) { echo $ortu->tgl_lahir_ibu; } else {echo set_value('tgl_ib'); }?>" placeholder="Tanggal Lahir">
                  ...
                  <!-- /.card-header -->
                    ...
                    <div class="col-sm-6">
                        <div class="input-group date" id="tanggallahir2" data-target-input="nearest">
                            <input type="text" name="tgl_wl" class="form-control datetimepicker-input" data-target="#tanggallahir2" value="<?php if(!empty($ortu->tgl_lahir_wali)) { echo $ortu->tgl_lahir_wali; } else {echo set_value('tgl_wl'); }?>" placeholder="Tanggal Lahir">
