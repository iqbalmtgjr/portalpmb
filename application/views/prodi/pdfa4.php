...
.tg .tg-0lax{text-align:left;vertical-align:top}
   ...
   <body style="margin: 30px;">
      ...
      <h4 class="upper text-center">Data Calon Mahasiswa Baru Tahun 2021</h4>
	...
	<p>PENDIDIKAN TERTINGGI SEBELUMNYA</p>
      <table width="100%" align="center" style="text-align:left">
          ...
          <tr>
              <th width="150" height="15">Nomor SKHUN</th> <td width="10" style="text-align:center;">:</td>
             <td><?php echo $warga->skhun_sekolah; ?></td>              
          </tr>
           <tr>
