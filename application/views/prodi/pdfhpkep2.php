...
<thead>
  <tr>
    <th class="tg-tysj">No</th>
    <th class="tg-0lax" width="10%">No.daf</th>
    <th class="tg-0lax">Nama</th>
     <th class="tg-0lax" width="10%">HP</th>
    <th class="tg-0lax">Keputusan</th>
    <th class="tg-0lax">Prodi</th>
     <th class="tg-0lax">Catatan</th>
  </tr>
</thead>
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0lax" width="10%"><?php echo $warga->hp_siswa; ?></td>
    <td class="tg-0lax"><?php echo $warga->keputusan_text; ?></td>
    <td class="tg-0lax"><?php echo $warga->nama_prodi; ?></td>
    <td class="tg-0lax"><?php echo $warga->note_penerimaan; ?></td>
  </tr>
  <?php } ?>
</tbody>
</table>
