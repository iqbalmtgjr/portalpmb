               ...
               Bagian 1 <span><i class="fa fa-angle-double-right"></i> Penambahan Data Jumlah SKS Persemester</span>
                <hr>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <input type="text" class="form-control" id="smt" name="smt_input" value="<?php echo $mahasiswa->smt_sks; ?>">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <input type="text" class="form-control" id="sks" name="sks" value="<?php echo $mahasiswa->sks_jumlah; ?>">
