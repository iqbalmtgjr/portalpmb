...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0lax">Rp. <?php $sel = $warga->jlh_bayar - 6660000; echo number_format("$sel",0,",","."); $tung += $sel ; ?></td>
   <?php } else{ ?>
    <td class="tg-0lax">Rp. 6.910.000 <?php $harus += 6910000; ?></td>
    <td class="tg-0lax">Rp. <?php $sel = $warga->jlh_bayar - 6910000; echo number_format("$sel",0,",","."); $tung += $sel ; ?></td>
   <?php } ?>
  </tr>
