         ...
         <div class="card card-info">
              ...
              <!-- /.card-header -->
               <?php
                ...
                <div class="card-body">
                        ...
                        <span>
                           ...
                           <?php } ?>
                            ...
                            <?php }elseif($dnama->jalur == "test") { 
                             foreach($item->result() as $item) { ?>
                                <p><?php echo $si++; ?>. <?php $fotal = $this->bank->item_rincidua($item->jenis_bayar_rinci)->row(); echo $fotal->item_biaya; $jlmfotaltes +=$fotal->jlh_uang; ?>, Semester <?php echo $item->smt_nama; ?> <?php echo $item->tahun_ajaran; ?> (<?php echo "Rp " . number_format($fotal->jlh_uang, 2, ",", ".");  ?>)</p>
                            <?php }
                                } 
                               }  ?>
                            </span>
                  ...
                  <?php if($this->session->userdata('pengguna_id_simkeu') == "45" || $this->session->userdata('pengguna_id_simkeu') == "49"){ ?>
                  <hr>
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              ...
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="sah" value="2" <?php if($dnama->validasi_bukti == "2"){ echo "checked";} ?>>VALID
                              </label>
                            </div>
                            <div class="form-check-inline">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="sah" value="3" <?php if($dnama->validasi_bukti == "3"){ echo "checked";} ?>>TIDAK VALID
                              </label>
                            </div>
        					 </div>
                          </div>
            ...
            <div class="card bg-gradient-info">
                    ...
                    <?php if(!empty($dnama->bukti_bayar)) {  ?>
                         ...
                         <img class="img-fluid mb-3" src="https://daftar.persadakhatulistiwa.ac.id/bayar/<?php echo $dnama->bukti_bayar; ?>" alt="Bukti bayar" style="max-width: 300px;"><br>
                        <a href="https://daftar.persadakhatulistiwa.ac.id/bayar/<?php echo $dnama->bukti_bayar; ?>" target="_blank" class="btn btn-warning mb-2">Lihat Bukti Bayar</a>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <?php }else{ echo $item->nomor_refe; } ?>
                        </td>
                      <td><?php echo number_format($item->jlh_bayar, 2, ",", "."); ?></td>
                      <td>
                          <?php if(!empty($item->bukti_bayar)) { ?>
                          <a href="https://daftar.persadakhatulistiwa.ac.id/bayar/<?php echo $item->bukti_bayar; ?>" target="_blank">Lihat</a>
                        <?php }else { ?>
                     ...
                     <?php } }else{ ?>
                      <tr><td colspan="7" class="text-danger">Belum ada pengajuan validasi transaksi</td></tr>
                     <?php } ?>
                  </tbody>
                </table>
				</div>
                    ...
                    <div class="card-body">
                         <div class="form-group row">
                            ...
                            <?php if($dnama->jalur == "prestasi") { ?>
                              <span class="form-control">Rp. 7.040.000</span>
                              <?php }else{ ?>
                               <span class="form-control">Rp. 7.290.000</span>
                              <?php } ?>
                            </div>
                          </div>
                           <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <span class="form-control"><?php echo "Rp " . number_format($ygsudah, 2, ",", "."); ?></span>
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              ...
                              echo "Rp " . number_format($tuggtol, 2, ",", "."); 
