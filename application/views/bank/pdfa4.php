...
<thead>
  <tr>
    ...
    <th class="tg-0lax">No. Referensi</th>
    <th class="tg-0lax">Nama Pengirim</th>
    <th class="tg-0lax">Tgl. Transaksi</th>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0lax"><?php echo $warga->nomor_refe; ?></td>
    <td class="tg-0lax"><?php echo $warga->nama_pengirim; ?><br> <span style="color:#4fa174;">dari</span> <?php echo $warga->bank_pengirim; ?></td>
    <td class="tg-0lax"><?php echo $warga->tgl_trans; ?><?php echo $warga->jam_trans; ?></td>
    <td class="tg-0lax"><?php echo "Rp " . number_format($warga->jlh_bayar, 2, ",", "."); $sum += $warga->jlh_bayar; ?></td>
   
  </tr>
  
  <?php } ?>
  <tr>
     <td class="tg-0lax" colspan="4">Jumlah Total</td>
