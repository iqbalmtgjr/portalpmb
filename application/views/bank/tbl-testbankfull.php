              ...
              <?php if (!empty($user)) { ?>
                ...
                <?php foreach ($user->result() as $user) { ?>
                  <tr>
                    ...
                    <td><?php if ($user->metode_bayar == "1") {
                          echo "<i class='text-info'>Panitia PMB</i>";
                        } elseif ($user->metode_bayar == "2") {
                          echo "<i class='text-success'>Transfer Bank</i>";
                        } else {
                          echo "<i class='text-danger'>Tidak Diketahui</i>";
                        } ?></td>
                    <td><?php if ($user->valid_bayar == "2") {
                          echo "Valid";
                        } elseif ($user->valid_bayar == "3") {
                          echo "Tidak Valid";
                        } else {
