...
<thead>
  <tr>
    ...
    <th class="tg-0lax">Pilihan I</th>
    <th class="tg-0lax">Pilihan II</th>
    <th class="tg-0lax">Pembayaran</th>
  </tr>
</thead>
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0lax"><?php echo $warga->nama_siswa; ?><br><small>No.Pend: <?php echo $warga->ref; ?></small><br><small>Hp: <?php echo $warga->hp_siswa; ?></small></td>
    <td class="tg-0lax"><?php echo $warga->nama_prodi; ?></td>
    <td class="tg-0lax"><?php echo $warga->nama_prodi_baru; ?></td>
    <td class="tg-0lax"><?php if($warga->valid_bayar == "2"){echo 'Valid';}else{echo '-';} ?></td>
  </tr>
  <?php } ?>
</tbody>
</table>
