...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0lax">Rp. <?php echo number_format("$warga->jlh_bayar",0,",","."); $sum += $warga->jlh_bayar; ?></td>
     <?php if($warga->jalur =="prestasi"){ ?>
    <!--<td class="tg-0lax">Rp. 6.660.000 <?php //$harus += 6660000; ?></td>-->
    <td class="tg-0lax">Rp. 7.040.000 <?php $harus += 7040000; ?></td>
   
    <td class="tg-0lax">Rp. <?php $sel = $warga->jlh_bayar - 7040000; echo number_format("$sel",0,",","."); $tung += $sel ; ?></td>
   <?php } else{ ?>
    <td class="tg-0lax">Rp. 7.290.000 <?php $harus += 7290000; ?></td>
    <td class="tg-0lax">Rp. <?php $sel = $warga->jlh_bayar - 7290000; echo number_format("$sel",0,",","."); $tung += $sel ; ?></td>
   <?php } ?>
  </tr>
...
<br>
<p>TARGET DAN DISTRIBUSI MABA 2023</p>
 <table class="tg">
<thead>
  <tr>
    <th class="tg-tysj">Nomor</th>
         ...
         <td class="tg-0lax"><?php echo $so++; ?></td>
          <td class="tg-0lax">Pendidikan Bahasa dan Sastra Indonesia</td>
           <td class="tg-0lax"><?php echo $pbsi; ?></td>
            <td class="tg-0lax"><?php $kelas1 = 1; echo $kelas1; ?></td>
             <td class="tg-0lax">40</td>
             <td class="tg-0lax">40</td>
             <td class="tg-0lax"><?php $pbsi_kurang = 40 - $pbsi; echo $pbsi_kurang;  ?></td>
     </tr>
      <tr>
         <td class="tg-0lax"><?php echo $so++; ?></td>
          <td class="tg-0lax">Pendidikan Matematika</td>
           <td class="tg-0lax"><?php echo $pmat; ?></td>
            <td class="tg-0lax"><?php $kelas2 = 1; echo $kelas2; ?></td>
             <td class="tg-0lax">40</td>
             <td class="tg-0lax">40</td>
             <td class="tg-0lax"><?php $pmat_kurang = 40 - $pmat; echo $pmat_kurang;  ?></td>
     </tr>
      <tr>
         <td class="tg-0lax"><?php echo $so++; ?></td>
