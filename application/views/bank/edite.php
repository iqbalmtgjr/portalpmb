                    ...
                    <div class="col-sm-8">
                        <span>
                            ...
                            foreach($item->result() as $item) { ?>
                                <p><?php echo $si++; ?>. <?php $fotal = $this->bank->item_rinci($item->jenis_bayar_rinci)->row(); echo $fotal->item_biaya; $jlmfotal +=$fotal->jlh_uang; ?>, Semester <?php echo $item->smt_nama; ?> <?php echo $item->tahun_ajaran; ?> (<?php echo "Rp " . number_format($fotal->jlh_uang, 2, ",", ".");  ?>) <a href="<?php echo base_url(); ?>bank/pustembay/<?php echo $item->id_pembayaran_rinci; ?>.html"><i class='fas fa-times text-danger'></i></a></p>
                            
                            <?php } } elseif($dnama->jalur == "test"){
                               foreach($item->result() as $item) { ?>
                                <p><?php echo $si++; ?>. <?php $fotal = $this->bank->item_rincidua($item->jenis_bayar_rinci)->row(); echo $fotal->item_biaya; $jlmfotaltest +=$fotal->jlh_uang; ?>, Semester <?php echo $item->smt_nama; ?> <?php echo $item->tahun_ajaran; ?> (<?php echo "Rp " . number_format($fotal->jlh_uang, 2, ",", ".");  ?>) <a href="<?php echo base_url(); ?>bank/pustembay/<?php echo $item->id_pembayaran_rinci; ?>.html"><i class='fas fa-times text-danger'></i></a></p>
