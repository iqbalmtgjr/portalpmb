...
<thead>
  <tr>
    ...
    <th class="tg-0lax">Nama /No. Pen</th>
    <th class="tg-0lax">Pilihan I & II</th>
    <th class="tg-0lax">Kep</th>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0lax"><?php echo $warga->nama_siswa; ?><br><small><?php echo $warga->ref; ?></small></td>
    <td class="tg-0lax">(I)<span style="color:#71de75;"><?php echo $warga->nama_prodi; ?></span><br>(II)<span style="color:#4f76d1;"><?php echo $warga->nama_prodi_baru; ?></span></td>
    <td class="tg-0lax"><?php if($warga->keputusan_text == "TIDAK LULUS") {echo '<span style="color:#bd160d;">'.$warga->keputusan_text.'</span>';} else {echo $warga->keputusan_text;} ?></td>
    <td class="tg-0lax"><?php if($warga->keputusan_text == "TIDAK LULUS"){echo '-';}else{echo $warga->nama_prodilain;} ?></td>
  </tr>
  <?php } ?>
</tbody>
</table>
