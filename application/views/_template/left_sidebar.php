...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block"><?php echo ucfirst($this->session->userdata('nama_simkeu')); ?></a>
            </div>
        </div>
                ...
                <?php if ($this->session->userdata('apli') == "pmb") { ?>
                    ...
                    <li class="nav-item has-treeview <?php if (!empty($pmbo)) {
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url(); ?>masterpmb/penvalido.html" class="nav-link <?php if (!empty($pmbo) && $pmbo == 'penvalido') {
                                                                                                                echo 'active';
                                                                                                            } ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Pendaftar Valid</p>
