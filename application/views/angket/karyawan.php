        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-dark text-center"> Angket Visi & Misi Semester Ganjil 2021/2022</h1>
             <h2 class="m-0 text-dark text-center"> Untuk Karyawan</h2>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
               ...
               <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                     ...
                     <tr>
                      <td>12.</td>
                      <td>Visi Misi menjadi acuan saya dalam bekerja <?php echo form_error('r12'); ?></td>
                      <td>
                     ...
                     <tr>
                      <td>13.</td>
                      <td>Saya melaksanakan fungsi pelayanan mengacu pada pencapaian visi misi <?php echo form_error('r13'); ?></td>
                      <td>
                     ...
                     <tr>
                      <td>14.</td>
                      <td>Saya tidak pernah lupa bawa tempat dimana saya bekerja harus menjadi perguruan tinggi yang paling kompeten <?php echo form_error('r14'); ?></td>
                      <td>
                     ...
                     <tr>
                      <td>15.</td>
                      <td>Loyalitas saya sangat diperlukan agar perguruan tinggi ini dapat mewujudkan visi misinya <?php echo form_error('r15'); ?></td>
                      <td>
