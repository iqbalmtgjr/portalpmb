                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-check-inline">
                      <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="metode_bayar" value="1" <?php if(!empty($siswa->metode_bayar) && $siswa->metode_bayar == 1) { echo "checked";}else { echo  set_radio('metode_bayar', 1);} ?>>Panitia PMB
                      </label>
                    </div>
                    <div class="form-check-inline">
                      <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="metode_bayar" value="2" <?php if(!empty($siswa->metode_bayar) && $siswa->metode_bayar == 2) { echo "checked";}else { echo  set_radio('metode_bayar', 2);} ?>>Transfer Bank
                      </label>
                    </div>
