                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                       <?php if(!empty($gam->semes_satu)){ ?>
					        <a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $gam->semes_satu; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
				        <?php }else { ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if(!empty($gam->semes_dua)){ ?>
					        <a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $gam->semes_dua; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
				        <?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $gam->semes_tiga; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
					<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $gam->semes_empat; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
					<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                     ...
                     <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $gam->semes_lima; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
				<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
