...
?>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                       <?php if(!empty($gam->semes_satu)){ ?>
					        <a href="https://daftar.persadakhatulistiwa.ac.id/assets/berkas/rapor/<?php echo $gam->semes_satu; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
				        <?php }else { ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if(!empty($gam->semes_dua)){ ?>
					        <a href="https://daftar.persadakhatulistiwa.ac.id/assets/berkas/rapor/<?php echo $gam->semes_dua; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
				        <?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/assets/berkas/rapor/<?php echo $gam->semes_tiga; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
					<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/assets/berkas/rapor/<?php echo $gam->semes_empat; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
					<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
    ...
    <!--                      <?php //if(!empty($gam->semes_lima)){ ?>-->
				<!--		<a href="https://daftar.persadakhatulistiwa.ac.id/assets/berkas/rapor/<?php echo $gam->semes_lima; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>-->
				<!--<?php //}else { ?>-->
				<!--        <span class="badge bg-danger">Belum Diupload</span>-->
				<!--        <?php //} ?>-->
    <!--                  </td>-->
    ...
    <tr>
                      ...
                      <td></td>
                      <td>
                          <?php if(!empty($gam->piagam)){ ?>
						<a href="https://daftar.persadakhatulistiwa.ac.id/assets/berkas/rapor/<?php echo $gam->piagam; ?>" target="_blank"><span class="badge bg-success">Diupload</span></a>
				<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
     ...
     <!--               <?php //echo form_close(); ?>-->
                ...
                <!-- /.card-body -->
                                <div class="card-body pb-0 pt-0">
                     <label>Sertifikat</label><span> (Format file : .jpg|pdf, Besar file maksimal 5MB)</span>
                    <?php echo form_open_multipart('masterpmb/piagam/'.$alam,'class="form-horizontal"'); ?> 
                  <div class="form-group">
                     <?php echo $this->session->flashdata('error_piagam'); ?>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="userfile" class="custom-file-input" id="customFile">
						<input type="hidden" name="file_name" />
