                  ...
                  <div class="form-group">
                    ...
                    <?php if(!empty($transak)) {  
                        ...
                        if(!empty($bukti->pembayaran_upload)){ ?>
                         <img class="img-fluid mb-3" src="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $bukti->pembayaran_upload; ?>" alt="Bukti bayar" style="max-width: 300px;"><br>
                        <a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $bukti->pembayaran_upload; ?>" target="_blank" class="btn btn-warning mb-2">Lihat Bukti Bayar</a>
