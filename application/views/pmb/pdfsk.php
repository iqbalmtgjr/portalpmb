   ...
   <body style="margin: 30px;">
      ...
      <div class="table">
          <div class="header" style="margin-bottom:-20px;">
            <img height="90" width="90"  style="float: left; padding-left: 30px; padding-top:-10px;" src="./assets/images/logo.png" alt="">
		   ...
		   <div class=" small-title text-center" style="padding-left: 10px;">Email: stkippersada@gmail.com Website : https://persadakhatulistiwa.ac.id</div>
         </div>
         <hr style="width: 100%;">
      </div>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-zp53">:</td>
    <td class="tg-zp53" colspan="2">Keputusan  hasil  rapat  Pimpinan dan Panitia Penerimaan Mahasiswa Baru (PMB) di lingkungan STKIP Persada Khatulistiwa Sintang yang dilaksanakan pada tanggal 1 September 2022.</td>
  </tr>
</tbody>
</table>
  ...
  <tr>
    ...
    <td class="tg-0lax">Penerimaan Mahasiswa Baru (PMB) Jalur <?php if($this->input->get('filter_jalur') == 'test'){
        ...
        if($this->input->get('filter_gelombang') == '1'){
            ...
            echo 'III';
        } else {echo 'I, II, dan III';} ?> Program Strata Satu (S1) pada Sekolah Tinggi Keguruan dan Ilmu Pendidikan Persada Khatulistiwa Sintang Tahun Akademik 2022/2023.</td>
  </tr>
  <tr>
    ...
    <td class="tg-0lax">Peserta dengan nomor Prestasit sebagaimana tercantum pada lampiran Surat Keputusan ini, yang dinyatakan LULUS Jalur <?php if($this->input->get('filter_jalur') == 'test'){
        ...
        if($this->input->get('filter_gelombang') == '1'){
            ...
            echo 'III';
        } else{echo 'I, II, dan III';} ?>, diwajibkan melakukan daftar ulang terdiri dari Biaya Registrasi (Rp. 1.510.000,00), Biaya Pengembangan Kampus (Rp. 3.000.000,00), dan Biaya Kuliah (SPP Tetap Rp. 2.150.000,00/Semester) Biaya  waktu pembayaran mulai tanggal 2 April 2022 s.d. 16 April 2022.</td>
  </tr>
  <tr>
    ...
    <td class="tg-0lax">Peserta seleksi Penerimaan Mahasiswa Baru (PMB) Jalur <?php if($this->input->get('filter_jalur') == 'test'){
        ...
        if($this->input->get('filter_gelombang') == '1'){
            ...
            echo 'III';
        } else{echo 'I, II, dan III';} ?> Program Strata Satu (S1) pada Sekolah Tinggi Keguruan dan Ilmu Pendidikan Persada Khatulistiwa Sintang Tahun Akademik 2022/2023 yang dinyatakan LULUS dan telah melakukan daftar ulang diberi hak untuk mengikuti kegiatan perkuliahan pada program Strata Satu (S1) Tahun Akademik 2022/2023.</td>
  </tr>
  <tr>
...
<h5 class="stt-title text-center upper">
    ...
    SEKOLAH TINGGI ILMU KEGURUAN DAN ILMU PENDIDIKAN <br>
    PERSADA KHATULISTIWA SINTANG <br>
    TAHUN AKADEMIK 2022/2023 <br><br>
...
<?php    
  ...
  echo "<tr>";
   ...
   echo '<td class="tg-0lax">'.$warga->ref.'</td>';
   $kata="$warga->nama_siswa";
   $kecil=strtolower($kata);
   echo '<td class="tg-0lax">'.ucwords($kecil).'</td>';
   echo '<td class="tg-0lax">'.$warga->keputusan_text.'</td>';
   echo '<td class="tg-0lax">'.$warga->nama_prodi.'</td>';
  echo "</tr>";
   } 
    }  else {
    echo "<tr>";
