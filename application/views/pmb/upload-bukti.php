    ...
    <div class="content">
      <div class="container-fluid">
		...
		<div class="card-header">
			...
			<?php echo form_open_multipart('masterpmb/ungbukti/'.$gam->id_bukti_bayar,'class="form-horizontal"');?>
			<div class="card-body">
			    <div class="form-group row">
						<label class="col-md-2 m-t-15"></label>
						<div class="col-lg-4">
							<?php if(!empty($gam->bukti_bayar)){ ?>
								<img src="https://daftar.persadakhatulistiwa.ac.id/bayar/<?php echo $gam->bukti_bayar; ?>" class="img-fluid img-thumbnail">
							<?php } else { ?>
