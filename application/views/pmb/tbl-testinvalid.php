      ...
      <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar Calon Mahasiswa Jalur Tes <?php if(!empty($jdl)) { echo $jdl; } ?></h3>
            ...
            <div class="row mb-3">
                    ...
                    <div class="col-4">
                    <form action="<?php echo base_url(); ?>masterpmb/set_gelombang_test2" method="post">
                    <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />			
                        <select name="filter_gel" id="" class="form-control">
                            <option value="">-- Pilih Gelombang --</option>
                            <option value="1" <?php if($this->session->userdata('filter_gel_test1')=='1'){echo "selected";}?>>Gelombang I</option>
                            <option value="2" <?php if($this->session->userdata('filter_gel_test1')=='2'){echo "selected";}?>>Gelombang II</option>
                            <option value="3" <?php if($this->session->userdata('filter_gel_test1')=='3'){echo "selected";}?>>Gelombang III</option>
                        </select>
                    </div>
                    <div class="col-4">
