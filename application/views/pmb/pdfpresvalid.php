...
<body style="margin: 30px;">
    <div class="wrapper">
        ...
        <h4 class="upper text-center"><?= $title ?></h4>
        ...
        <table class="tg">
            <thead>
                <tr>
                    <th class="tg-0lax">No Daftar</th>
                    <th class="tg-0lax">Nama</th>
                    <th class="tg-0lax">Pilihan 1</th>
                    <th class="tg-0lax">Pilihan 2</th>
                    <th class="tg-0lax">Gel</th>
                    <th class="tg-0lax">sm1</th>
                    <th class="tg-0lax">sm2</th>
                    <th class="tg-0lax">sm3</th>
                    <th class="tg-0lax">sm4</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($warga as $warga) { ?>
                    <tr>
                        ...
                        <td class="tg-0lax"><?php echo $warga->nama_prodi_baru; ?></td>
                        <td class="tg-0lax"><?php echo $warga->gelombang; ?></td>
                        <td class="tg-0lax"><?php echo $warga->nilai_satu; ?></td>
                        <td class="tg-0lax"><?php echo $warga->nilai_dua; ?></td>
                        <td class="tg-0lax"><?php echo $warga->nilai_tiga; ?></td>
                        <td class="tg-0lax"><?php echo $warga->nilai_empat; ?></td>
