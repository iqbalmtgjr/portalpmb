...
<thead>
  <tr>
    ...
    <th class="tg-0lax">Nomor Pendaftaran</th>
    <th class="tg-0lax">Nama</th>
    <th class="tg-0lax">Keputusan</th>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0lax"><?php echo $warga->keputusan_text; ?></td>
...
<table style="padding-top: 10px; width: 50%; float: right; border: none;">
			<tbody>
              <tr>
                 <td style="width: 50%; text-align: center; font-weight: normal;">Sintang, <?php $ger = date("d/m/Y"); echo tgl_indo1($ger); ?></td> 
              </tr>
              <tr>
                 <td style="width: 50%; text-align: center; font-weight: bold; padding-top:40px;">Panitia PMB</td> 
              </tr>
