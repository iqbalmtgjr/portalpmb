      ...
      <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar Calon Mahasiswa Jalur Prestasi <?php if(!empty($jdl)) { echo $jdl; } ?> dengan Pembayaran Tervalidasi</h3>
                ...
                <div class="row mb-3">
                    ...
                    <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />			
                        <select name="filter_gel" id="" class="form-control">
                            ...
                            <option value="1" <?php if($this->session->userdata('filter_gel')=='1'){echo "selected";}?>>Gelombang I</option>
                            <option value="2" <?php if($this->session->userdata('filter_gel')=='2'){echo "selected";}?>>Gelombang II</option>
                            <option value="3" <?php if($this->session->userdata('filter_gel')=='3'){echo "selected";}?>>Gelombang III</option>
                        </select>
                    </div>
                    <div class="col-4">
