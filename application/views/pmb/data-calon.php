                    ...
                    <tr>
                      ...
                      <td>
                       <?php if(!empty($siswa->foto_upload)){ ?>
					        <a href="https://daftar.persadakhatulistiwa.ac.id/foto/<?php echo $siswa->foto_upload; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
				        <?php }else { ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if(!empty($siswa->ijasah_upload)){ ?>
					        <a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->ijasah_upload; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
				        <?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
     ...
     <!--               </tr>-->
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->skkb_upload; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
					<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                     ...
                     <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->kk_upload; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
				<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->akta_lahir_upload; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
				<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->ktp_upload; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
				<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->ket_lulus_upload; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
					   <?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                     ...
                     <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->pembayaran_upload; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
				<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                       <?php if(!empty($siswa->semes_satu)){ ?>
					        <a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->semes_satu; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
				        <?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if(!empty($siswa->semes_dua)){ ?>
					        <a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->semes_dua; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
				        <?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->semes_tiga; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
					<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->semes_empat; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
					<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
                     ...
                     <tr>
                      ...
                      <td>
						...
						<a href="https://daftar.persadakhatulistiwa.ac.id/pdf/<?php echo $siswa->semes_lima; ?>" target="_blank"><span class="badge bg-success">Lihat</span></a>
				<?php }else { ?>
				        <span class="badge bg-danger">Belum Diupload</span>
				        <?php } ?>
                      </td>
