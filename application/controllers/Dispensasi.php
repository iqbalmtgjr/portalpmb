...
class Dispensasi extends CI_Controller {
	...
	{	
		...
		$this->form_validation->set_rules('no', 'Nomor Dokumen','trim|required|is_unique[dispen.no]',
			array(
        ...
        $this->form_validation->set_rules('tunggak', 'Tunggakan','trim|required|numeric',
			array(
					'required'      => '%s tidak boleh kosong!',
					'numeric'      => '%s harus angka!'
			)
        );
        $this->form_validation->set_rules('cicil', 'Cicilan Tunggakan','trim|required|numeric',
			array(
					'required'      => '%s tidak boleh kosong!',
					'numeric'      => '%s harus angka!'
			)
        );
        $this->form_validation->set_rules('tglbuat', 'Tanggal Dispensasi','trim|required',
			array(
					'required'      => '%s tidak boleh kosong!'
			)
        );
        $this->form_validation->set_rules('kadaluarsa', 'Kadaluarsa Dispensasi','trim|required',
			array(
					'required'      => '%s tidak boleh kosong!'
			)
        );
        $this->form_validation->set_rules('keperluan', 'Keperluan Dispensasi','trim|required',
			array(
					'required'      => '%s tidak boleh kosong!'
			)
        );
