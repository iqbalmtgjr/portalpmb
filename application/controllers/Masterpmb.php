...
class Masterpmb extends CI_Controller
{
    ...
    public function umumkan($id = 0)
    {
        if ($this->session->userdata('pengguna_id_simkeu') == "45" || $this->session->userdata('pengguna_id_simkeu') == "49") {
            ...
            // jika jalur test
            if ($cek->jalur == "test") {
                $url = 'https://daftar.persadakhatulistiwa.ac.id/login/index.html';
                $link = '<a href="' . $url . '">' . $url . '</a>';
                $message = '';
                $message .= '<strong>Pengumuman Penerimaan Calon Mahasiswa Baru STKIP Persada Khatulistiwa Tahun 2023 Jalur Tes Gelombang 3</strong><br>';
                ...
                if ($periksa->status_penerimaan == "1") {
                    ...
                    $message .= '<strong> Catatan : </strong> Silahkan melakukan registrasi keuangan pada tanggal 16 sampai dengan 31 Agustus 2023<br>';
                    $message .= '<strong> Biaya yang harus dibayar pada saat registrasi sebesar Rp. 7.290.000 dengan rincian:</strong><br>';
                    $message .= '<strong> 1. Uang Registrasi Rp.1.510.000</strong><br>';
                    $message .= '<strong> 2. Uang Pengembangan Kampus Rp.3.500.000</strong><br>';
                    $message .= '<strong> 3. SPP Tetap Per Semester Rp.2.280.000</strong><br>';
                ...
                $link = '<a href="' . $url . '">' . $url . '</a>';
                $message = '';
                $message .= '<strong>Pengumuman Penerimaan Calon Mahasiswa Baru STKIP Persada Khatulistiwa Tahun 2023 Jalur Prestasi Gelombang 3</strong><br>';
                $message .= '<strong> Nomor Pendaftaran : </strong>' . $cek->ref . '<br>';
                $message .= '<strong> Nama : </strong>' . $cek->nama_siswa . '<br>';
                $message .= '<strong> Status Penerimaan : </strong>' . $cek->keputusan_text . '<br>';
                $message .= '<strong> Ket. : </strong>' . $cek->note_penerimaan . '<br>';
                if ($periksa->status_penerimaan == "1") {
                    $message .= '<strong> Diterima pada Prodi : </strong>' . $cek->nama_prodi . '<br>';
                    $message .= '<strong> Catatan : </strong> Silahkan melakukan registrasi pada tanggal 16 sampai dengan 31 Agustus 2023<br>';
                    $message .= '<strong> Biaya yang harus dibayar pada saat registrasi sebesar Rp. 7.040.000 dengan rincian:</strong><br>';
                    $message .= '<strong> 1. Uang Registrasi Rp.1.510.000</strong><br>';
                    $message .= '<strong> 2. Uang Pengembangan Kampus Rp.3.250.000</strong><br>';
                    $message .= '<strong> 3. SPP Tetap Per Semester Rp.2.280.000</strong><br>';
                    $message .= 'Pembayaran Registrasi  melalui Teller Bank KALBAR ke Nomor Rekening 4010006517 (BANK KALBAR) Atas Nama PRKMPULN BDN PEND KARYA BANGSA. 
                                        Tuliskan <strong>' . $cek->ref . '</strong> pada kolom berita di slip transfer bank. 
                    ...
                    $message .= '<strong>Panitia hanya menerima pembayaran yang dilakukan melalui BANK.</strong><br>';
                }
                $message .= '<strong>Untuk Login Silahkan klik: </strong> ' . $link;
            }
            //	echo ($message); die();
            ...
            $config['smtp_host'] = "ssl://daftar.persadakhatulistiwa.ac.id";
            $config['smtp_port'] = "465";
            $config['smtp_user'] = "admin@daftar.persadakhatulistiwa.ac.id";
            $config['smtp_pass'] = "sampahsemua";
            $config['charset'] = "utf-8";
            $config['mailtype'] = "html";
            $config['newline'] = "\r\n";
            $ci->email->initialize($config);
            $ci->email->from('admin@daftar.persadakhatulistiwa.ac.id', 'Panitia PMB');
            $list = $cek->email_akun_siswa;
            // $list = 'thesariopan@gmail.com'; 
            //  $list = 'adrianagandasari@gmail.com';
            $ci->email->to($list);
            $ci->email->subject('Pengumuman PMB STKIP Persada Khatulistiwa 2023');
    ...
    {
        if ($this->session->userdata('pengguna_id_simkeu') == "45" || $this->session->userdata('pengguna_id_simkeu') == "53" || $this->session->userdata('pengguna_id_simkeu') == "49" || $this->session->userdata('pengguna_id_simkeu') == "39") {
    ...
    public function pdfsk($jalur = "", $gelombang = "")
    {
        ...
        $filename = 'Surat Keputusan PMB 2023';
        $this->pdfgenerator1->generate($html, $filename, true, 'A4', 'portrait');
    }
...
",
    ...
    {
        if ($this->session->userdata('pengguna_id_simkeu') == "39" || $this->session->userdata('pengguna_id_simkeu') == "45" || $this->session->userdata('pengguna_id_simkeu') == "49") {
    ...
    public function foto($byid = 0)
    {
        if ($this->session->userdata('pengguna_id_simkeu') == "53" || $this->session->userdata('pengguna_id_simkeu') == "45" || $this->session->userdata('pengguna_id_simkeu') == "49") {
            ...
            $config['upload_path'] = '../daftar.persadakhatulistiwa.ac.id/foto/';
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->foto_upload)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/foto/' . $bilgam->foto_upload;
                        $res = @unlink($path);
                    }
    ...
    public function ijasah($byid = 0)
    {
        if ($this->session->userdata('pengguna_id_simkeu') == "53" || $this->session->userdata('pengguna_id_simkeu') == "45" || $this->session->userdata('pengguna_id_simkeu') == "49") {
            ...
            $config['upload_path'] = '../daftar.persadakhatulistiwa.ac.id/pdf/';
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->ijasah_upload)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->ijasah_upload;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->skhu_upload)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->skhu_upload;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->skkb_upload)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->skkb_upload;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->kk_upload)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->kk_upload;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->ktp_upload)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->ktp_upload;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->akta_lahir_upload)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->akta_lahir_upload;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->ket_lulus_upload)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->ket_lulus_upload;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->pembayaran_upload)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->pembayaran_upload;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->semes_satu)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->semes_satu;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->semes_dua)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->semes_dua;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->semes_tiga)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->semes_tiga;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->semes_empat)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->semes_empat;
                        $res = @unlink($path);
                    }
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                if (!empty($bilgam)) {
                    if (!empty($bilgam->semes_lima)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/pdf/' . $bilgam->semes_lima;
                        $res = @unlink($path);
                    }
    ...
    public function ungbukti($id = 0)
    {
        if ($this->session->userdata('pengguna_id_simkeu') == "53" || $this->session->userdata('pengguna_id_simkeu') == "45" || $this->session->userdata('pengguna_id_simkeu') == "49") {
            ...
            if ($cekkk->jalur == "prestasi" && $cekkk->status_penerimaan == "1" && $cekkk->umumkan == "1") {
                ...
                $config['upload_path'] = '../daftar.persadakhatulistiwa.ac.id/bayar/';
                ...
                if (!$this->upload->do_upload('userfile')) {
                    ...
                    if (!empty($bilgam->bukti_bayar)) {
                        $path = '../daftar.persadakhatulistiwa.ac.id/bayar/' . $bilgam->bukti_bayar;
                        $res = @unlink($path);
                    }
    ...
    public function sk()
    {
        // 	 print_r($this->input->get('filter_jalur')); die;
        $data = array(
